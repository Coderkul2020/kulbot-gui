...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve Suny',
        description: 'Suny telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The Suny Team is always looking to better understand how Suny is used around the ' +
            'world. To help support this effort, you can allow Suny to automatically send usage information to ' +
            'the Suny Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the Suny privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the Suny Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the Suny Team',
        description: 'Text for telemetry modal opt-in button',
