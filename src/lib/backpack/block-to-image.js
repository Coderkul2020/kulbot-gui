...
import ScratchBlocks from 'kulbot-block';
...
export default function (blockId) {
    // Not sure any better way to access the kulbot-block workspace than this...
    ...
    return new Promise(resolve => {
        setTimeout(() => {
            ...
            computedStyleToInlineStyle(svg, {
                ...
                // Specifically properties that are set from CSS in kulbot-block
