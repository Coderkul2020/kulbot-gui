 ...
 */
class OpenBlockArduinoSunyDevice {
    /**
    ...
    constructor (runtime, originalDeviceId) {
        ...
        this._peripheral = new ArduinoSuny(this.runtime, OpenBlockArduinoSunyDevice.DEVICE_ID, originalDeviceId);
    }
                ...
                blocks: [
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32lcdNumber',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32lcdString',
                    ...
                    '---',
                    {
                        opcode: 'esp32setupLed',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupLed',
                            default: 'Initialize LEDs [REF]',
                            description: 'arduinoSuny setup KULBOT_RGB_INIT'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            REF: {
                    ...
                    '---',
                    {
                        opcode: 'esp32setupMotor',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupMotor',
                            default: 'Initialize Motor',
                            description: 'arduinoSuny setup KULBOT MOTOR'
                        }),
                        blockType: BlockType.COMMAND,
                    },
                    ...
                    '---',
                    {
                        opcode: 'esp32setupServo',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupServo',
                            default: 'Initialize Servo',
                            description: 'arduinoSuny setup KULBOT SERVO'
                        }),
                        blockType: BlockType.COMMAND,
                    },
                    ...
                    '---',
                    {
                        opcode: 'esp32setupSensor',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupSensor',
                            default: 'Initialize Sensor',
                            description: 'arduinoSuny setup KULBOT SENSOR'
                        }),
                        blockType: BlockType.COMMAND,
                    },
                    ...
                    '---',
                    {
                        opcode: 'esp32setupDHT',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupDHT',
                            default: 'Set Up Temperature & Humidity: Port [PORT]',
                            description: 'arduinoSuny setup Temperature & Humidity'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PORT: {
                    ...
                    '---',
                    {
                        opcode: 'esp32setupLine',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupLine',
                            default: 'Set Up Line Sensor: Port [PORT]',
                            description: 'arduinoSuny setup Line Sensor'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PORT: {
                    ...
                    '---',
                    {
                        opcode: 'esp32setupIR',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupIR',
                            default: 'Set Up IR Sensor: Port [PORT]',
                            description: 'arduinoSuny setup IR Sensor'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PORT: {
                    ...
                    '---',
                    {
                        opcode: 'esp32setupTouch',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupTouch',
                            default: 'Set Up Touch Sensor: Port [PORT]',
                            description: 'arduinoSuny setup Touch Sensor'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PORT: {
                    ...
                    '---',
                    {
                        opcode: 'esp32setupTrafficLight',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupTrafficLight',
                            default: 'Set Up Traffic Light: Port [PORT]',
                            description: 'arduinoSuny setup Traffic Light'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PORT: {
                    ...
                    '---',
                    {
                        opcode: 'esp32setupButtonLed',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupButtonLed',
                            default: 'Set Up Button Led: Port [PORT]',
                            description: 'arduinoSuny setup Button Led'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PORT: {
                    ...
                    '---',
                    {
                        opcode: 'esp32setupGryro',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupGryro',
                            default: 'Set Up Gryro: Port [PORT]',
                            description: 'arduinoSuny setup Gryro'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PORT: {
                    ...
                    '---',
                    {
                        opcode: 'esp32setupColor',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupColor',
                            default: 'Set Up Color: Port [PORT]',
                            description: 'arduinoSuny setup Color'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PORT: {
                    ...
                    '---',
                    {
                        opcode: 'esp32setupLCD',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setupLCD',
                            default: 'Set Up LCD: Port [PORT]',
                            description: 'arduinoSuny setup LCD'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PORT: {
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            ...
                            default: 'Turn All Led: Port [COLOR]',
...

                    {
                        opcode: 'esp32setled',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.esp32setled',
                            default: 'Set Led: Port [PIN] Color [COLOR]',
                    ...
                    "---",
                    {
                        opcode: 'eps32SUltra',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32SUltra',
                    ...
                    '---',
                    {
                        opcode: 'eps32STemp',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32STemp',
                    ...
                    '---',
                    {
                        opcode: 'eps32SDHT11',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32SDHT11',
                    ...
                    '---',
                    {
                        opcode: 'eps32SDHT12',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32SDHT12',
                    ...
                    '---',
                    {
                        opcode: 'eps32STouch',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32STouch',
                            default: 'Touch [PIN]',
                    ...
                    '---',            
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32STouchLed',
                            default: 'TouchLED Port [PIN]  color [CLINE]',
                            description: 'arduinoSuny set IR color pin out'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    '---',     
                    {
                        opcode: 'eps32SLine',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32SLine',
                    ...
                    '---',            
                    {
                        opcode: 'eps32SIRLed',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32SIRLed',
                    ...
                    '---',            
                    {
                        opcode: 'eps32traLED',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32traLED',
                    ...
                    '---',            
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32SMotorM1',
                    ...
                    '---',
                    {
                        opcode: 'eps32SServo',
                        text: formatMessage({
                            id: 'arduinoSuny.pins.eps32SServo',
     ...
     */
     esp32OnAllLed (args) {
        this._peripheral.esp32OnAllLed(args.COLOR);
        return Promise.resolve();
    }
     ...
     */
    esp32setled (args) {
        this._peripheral.esp32setled(args.PIN, args.COLOR);
        return Promise.resolve();
    }
     ...
     */
     esp32setupLed (args) {
        this._peripheral.esp32setupLed(args.REF);
        return Promise.resolve();
    }
     ...
     * @return {Promise} - a Promise that resolves after the set Led out value is done.
     */
     esp32setupMotor (args) {
        this._peripheral.esp32setupMotor();
        return Promise.resolve();
    }
     ...
     * @return {Promise} - a Promise that resolves after the set Led out value is done.
     */
     esp32setupServo (args) {
        this._peripheral.esp32setupServo();
        return Promise.resolve();
    }
     ...
     * @return {Promise} - a Promise that resolves after the set Led out value is done.
     */
     esp32setupSensor (args) {
        this._peripheral.esp32setupSensor();
        return Promise.resolve();
    }
     ...
     */
     esp32setupDHT (args) {
        this._peripheral.esp32setupDHT(args.PORT);
        return Promise.resolve();
    }
     ...
     */
     esp32setupLine (args) {
        this._peripheral.esp32setupLine(args.PORT);
        return Promise.resolve();
    }
     ...
     */
     esp32setupIR (args) {
        this._peripheral.esp32setupIR(args.PORT);
        return Promise.resolve();
    }
     ...
     * @return {Promise} - a Promise that resolves after the set Led out value is done.
     */
     esp32setupTouch (args) {
        this._peripheral.esp32setupTouch(args.PORT);
        return Promise.resolve();
    }
     ...
     * @return {Promise} - a Promise that resolves after the set Led out value is done.
     */
     esp32setupTrafficLight (args) {
        this._peripheral.esp32setupTrafficLight(args.PORT);
        return Promise.resolve();
    }
     ...
     * @return {Promise} - a Promise that resolves after the set Led out value is done.
     */
     esp32setupButtonLed (args) {
        this._peripheral.esp32setupButtonLed(args.PORT);
        return Promise.resolve();
    }
     ...
     * @return {Promise} - a Promise that resolves after the set Led out value is done.
     */
     esp32setupGryro (args) {
        this._peripheral.esp32setupGryro(args.PORT);
        return Promise.resolve();
    }
     ...
     * @return {Promise} - a Promise that resolves after the set Led out value is done.
     */
     esp32setupColor (args) {
        this._peripheral.esp32setupColor(args.PORT);
        return Promise.resolve();
    }
     ...
     */
     esp32setupLCD (args) {
        this._peripheral.esp32setupLCD(args.PORT);
        return Promise.resolve();
    }
...
module.exports = OpenBlockArduinoSunyDevice;
