...
<header>
        ...
        MicroBit
            ...
            <div class="class-description usertext"><p>Manage communication with a MicroBit peripheral over a Scrath Link client socket.</p></div>
...
<div class="description usertext">
    <p>A flag that is true while we are busy sending data to the BLE socket.</p>
</div>
...
<dl class="details">
    ...
    <h4 class="name" id="_checkPinState"><span class="type-signature">(private) </span>_checkPinState<span class="signature">(pin)</span><span class="type-signature"> &rarr; {number}</span></h4>
...
<div class="description usertext">
    <p>Disconnect from the micro:bit.</p>
</div>
...
<div class="param-desc">
    <ul>
<li>a Promise that resolves when writing to peripheral.</li>
</ul>
</div>
...
<div class="description usertext">
    <p>Return true if connected to the micro:bit.</p>
</div>
...
<div class="param-desc">
    <ul>
<li>whether the micro:bit is connected.</li>
</ul>
</div>
...
<div class="description usertext">
    ...
    <h4 class="name" id="send"><span class="type-signature"></span>send<span class="signature">(command, message)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Send a message to the peripheral BLE socket.</p>
</div>
