...
<p>Note: This way of looping through motors is currently unnecessary, but could be
useful if an 'all motors' option is added in the future (see WeDo2 extension).</p>
</div>
...
<span class="param-type">function</span>
    ...
    <h4 class="name" id="_formatMenu"><span class="type-signature">(private) </span>_formatMenu<span class="signature">(menu)</span><span class="type-signature"> &rarr; {object}</span></h4>
...
<div class="description usertext">
    <p>Formats menus into a format suitable for block menus, and loading previously
saved projects:
[
{
text: label,
...
<span class="param-type">array</span>
            ...
            <td class="description last"><p>a menu to format.</p></td>
        </tr>
...
<div class="param-desc">
    <ul>
<li>a formatted menu as an object.</li>
</ul>
</div>
