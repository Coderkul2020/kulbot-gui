...
<header>
        ...
        WeDo2
            ...
            <div class="class-description usertext"><p>Manage communication with a WeDo 2.0 peripheral over a Bluetooth Low Energy client socket.</p></div>
...
<h4 class="name" id="_batteryLevelIntervalId"><span class="type-signature">(private) </span>_batteryLevelIntervalId<span class="type-signature"> :number</span></h4>
...
<div class="description usertext">
    <p>A list of the ids of the motors or sensors in ports 1 and 2.</p>
</div>
...
<dl class="details">
    ...
    <h4 class="name" id="_checkBatteryLevel"><span class="type-signature"></span>_checkBatteryLevel<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Check the battery level on the WeDo 2.0. If the WeDo 2.0 has disconnected
...
<div class="description usertext">
    <p>Sets LED mode and initial color and starts reading data from peripheral after BLE has connected.</p>
</div>
...
<span class="param-type">object</span>
    ...
    <h4 class="name" id="_registerSensorOrMotor"><span class="type-signature">(private) </span>_registerSensorOrMotor<span class="signature">(connectID, type)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Called by the runtime when user wants to connect to a certain WeDo 2.0 peripheral.</p>
</div>
...
<div class="description usertext">
    <p>Disconnects from the current BLE socket.</p>
</div>
    ...
    <h4 class="name" id="generateInputCommand"><span class="type-signature"></span>generateInputCommand<span class="signature">(connectID, type, mode, delta, units, enableNotifications)</span><span class="type-signature"> &rarr; {array}</span></h4>
...
<div class="description usertext">
    <p>Generate a WeDo 2.0 'Input Command' in the byte array format
(COMMAND ID, COMMAND TYPE, CONNECT ID, TYPE ID, MODE, DELTA INTERVAL (4 BYTES),
UNIT, NOTIFICATIONS ENABLED).</p>
<p>This sends a command to the WeDo 2.0 that sets that input format
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the type of input sensor.</p></td>
        </tr>
...
<span class="param-type">array</span>
            ...
            <td class="description last"><p>the unit of the input sensor value.</p></td>
        </tr>
...
<span class="param-type">array</span>
    ...
    <h4 class="name" id="generateOutputCommand"><span class="type-signature"></span>generateOutputCommand<span class="signature">(connectID, commandID, values)</span><span class="type-signature"> &rarr; {array}</span></h4>
...
<div class="description usertext">
    <p>Generate a WeDo 2.0 'Output Command' in the byte array format
(CONNECT ID, COMMAND ID, NUMBER OF BYTES, VALUES ...).</p>
<p>This sends a command to the WeDo 2.0 to actuate the specified outputs.</p>
</div>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the id of the byte command.</p></td>
        </tr>
...
<span class="param-type">array</span>
            ...
            <td class="description last"><p>the list of values to write to the command.</p></td>
        </tr>
...
<div class="description usertext">
    <p>Called by the runtime to detect whether the WeDo 2.0 peripheral is connected.</p>
</div>
...
<div class="description usertext">
    <p>Play a tone from the WeDo 2.0 peripheral for a specific amount of time.</p>
</div>
...
<div class="description usertext">
    <p>Called by the runtime when user wants to scan for a WeDo 2.0 peripheral.</p>
</div>
...
<div class="description usertext">
    <p>Write a message to the WeDo 2.0 peripheral BLE socket.</p>
</div>
...
<div class="description usertext">
    <p>Set the WeDo 2.0 peripheral's LED to a specific color.</p>
</div>
...
<div class="description usertext">
    <p>Stop the tone playing and motors on the WeDo 2.0 peripheral.</p>
</div>
...
<div class="description usertext">
    <p>Switch off the LED on the WeDo 2.0.</p>
</div>
...
<div class="description usertext">
    <p>Stop the tone playing from the WeDo 2.0 peripheral, if any.</p>
</div>
