...
<header>
        ...
        RenderedTarget
            ...
            <div class="class-description usertext"><p>Rendered target: instance of a sprite (clone), or the stage.</p></div>
...
<h4 class="name" id="textToSpeechLanguage"><span class="type-signature"></span>textToSpeechLanguage<span class="type-signature"> :string</span></h4>
...
<div class="description usertext">
    <p>The language to use for speech synthesis, in the text2speech extension.
It is initialized to null so that on extension load, we can check for
this and try setting it using the editor locale.</p>
</div>
