...
<head>
    ...
    <meta charset="utf-8">
    <title>ArduinoPeripheral - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ArduinoPeripheral</h1>
...
<header>
        ...
        ArduinoPeripheral
            ...
            <div class="class-description usertext"><p>Manage communication with a Arduino peripheral over a Suny Link client socket.</p></div>
...
<article>
    ...
    <h4 class="name" id="ArduinoPeripheral"><span class="type-signature"></span>new ArduinoPeripheral<span class="signature">(runtime, deviceId, originalDeviceId, pnpidList, serialConfig, diveceOpt)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Construct a Arduino communication object.</p>
</div>
...
<span class="param-type"><a href="Runtime.html">Runtime</a></span>
            ...
            <td class="description last"><p>the Suny runtime</p></td>
        </tr>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>originalDeviceId</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>the original id of the peripheral, like xxx_arduinoUno</p></td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>the pnp id of the peripheral</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>serialConfig</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>the serial config of the peripheral</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>diveceOpt</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>the device optione of the peripheral</p></td>
        </tr>
...
<h4 class="name" id="_deviceId"><span class="type-signature"></span>_deviceId<span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>The id of the peripheral this peripheral belongs to.</p>
</div>
...
<h4 class="name" id="_firmata"><span class="type-signature">(private, nullable) </span>_firmata<span class="type-signature"> :<a href="Firmata.html">Firmata</a></span></h4>
...
<span class="param-type"><a href="Firmata.html">Firmata</a></span>
...
<h4 class="name" id="_firmataIntervelID"><span class="type-signature">(private) </span>_firmataIntervelID<span class="type-signature"> :number</span></h4>
...
<div class="description usertext">
    <p>Interval ID for firmata send heartbeat.</p>
</div>
...
<h4 class="name" id="_firmataTimeoutID"><span class="type-signature">(private) </span>_firmataTimeoutID<span class="type-signature"> :number</span></h4>
...
<div class="description usertext">
    <p>Timeout ID for firmata get heartbeat timeout.</p>
</div>
...
<h4 class="name" id="_isFirmataConnected"><span class="type-signature">(private) </span>_isFirmataConnected<span class="type-signature"> :boolean</span></h4>
...
<div class="description usertext">
    <p>A flag that is true while firmata is conncted.</p>
</div>
...
<h4 class="name" id="_pendingData"><span class="type-signature"></span>_pendingData<span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Pending data list. If busy is set when send, the data will push into this array to
waitting to be sended.</p>
</div>
...
<div class="description usertext">
    <p>The Suny runtime used to trigger the green flag button.</p>
</div>
...
<h4 class="name" id="_serialport"><span class="type-signature">(private) </span>_serialport<span class="type-signature"> :SERIALPORT</span></h4>
...
<div class="description usertext">
    <p>The serialport connection socket for reading/writing peripheral data.</p>
</div>
...
<span class="param-type">SERIALPORT</span>
    ...
    <h4 class="name" id="_handleProgramModeUpdate"><span class="type-signature"></span>_handleProgramModeUpdate<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Handle the program mode update event. If in realtime mode start the heartbeat else stop.</p>
</div>
    ...
    <h4 class="name" id="_listenHeartbeat"><span class="type-signature">(private) </span>_listenHeartbeat<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Listen the heartbeat and emit connection state event.</p>
</div>
...
<div class="description usertext">
    <p>Starts reading data from peripheral after serialport has connected to it.</p>
</div>
...
<div class="description usertext">
    <p>Process the sensor data from the incoming serialport characteristic.</p>
</div>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>the incoming serialport data.</p></td>
        </tr>
    ...
    <h4 class="name" id="_startHeartbeat"><span class="type-signature">(private) </span>_startHeartbeat<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Start send/recive heartbeat timer.</p>
</div>
    ...
    <h4 class="name" id="_stopHeartbeat"><span class="type-signature">(private) </span>_stopHeartbeat<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Stop send/recive heartbeat timer.</p>
</div>
    ...
    <h4 class="name" id="connect"><span class="type-signature"></span>connect<span class="signature">(id, baudrate<span class="signature-attributes">nullable</span>)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Called by the runtime when user wants to connect to a certain peripheral.</p>
</div>
...
<div class="description usertext">
    <p>Disconnect from the peripheral.</p>
</div>
...
<div class="description usertext">
    <p>Return true if connected to the peripheral.</p>
</div>
...
<div class="param-desc">
    <ul>
<li>whether the peripheral is connected.</li>
</ul>
</div>
...
<div class="description usertext">
    <p>Return true if peripheral has connected to firmata and program mode is realtime.</p>
</div>
...
<div class="param-desc">
    <ul>
<li>whether the peripheral is ready for realtime mode communication.</li>
</ul>
</div>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="parseLevel"><span class="type-signature"></span>parseLevel<span class="signature">(level)</span><span class="type-signature"> &rarr; {number}</span></h4>
...
<span class="param-type">LEVEL</span>
            ...
            <td class="description last"><p>the level string to parse.</p></td>
        </tr>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="parsePin"><span class="type-signature"></span>parsePin<span class="signature">(pin)</span><span class="type-signature"> &rarr; {number}</span></h4>
...
<span class="param-type">PIN</span>
            ...
            <td class="description last"><p>the pin string to parse.</p></td>
        </tr>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="readAnalogPin"><span class="type-signature"></span>readAnalogPin<span class="signature">(pin)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">PIN</span>
            ...
            <td class="description last"><p>the pin to read.</p></td>
        </tr>
...
<div class="param-desc">
    <ul>
<li>a Promise that resolves when read from peripheral.</li>
</ul>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="readDigitalPin"><span class="type-signature"></span>readDigitalPin<span class="signature">(pin)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description usertext">
    <p>Reset all the state and timeout/interval ids.</p>
</div>
    ...
    <h4 class="name" id="scan"><span class="type-signature"></span>scan<span class="signature">(pnpidList, listAll)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Called by the runtime when user wants to scan for a peripheral.</p>
</div>
...
<span class="param-type">Array.&lt;string></span>
            ...
            <td class="description last"><p>the array of pnp id list</p></td>
        </tr>
...
<div class="description usertext">
    <p>Send a message to the peripheral Serialport socket.</p>
</div>
...
<span class="param-type">Uint8Array</span>
    ...
    <h4 class="name" id="setBaudrate"><span class="type-signature"></span>setBaudrate<span class="signature">(baudrate)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Set baudrate of the peripheral serialport.</p>
</div>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="setDigitalOutput"><span class="type-signature"></span>setDigitalOutput<span class="signature">(pin, level)</span><span class="type-signature"></span></h4>
...
<span class="param-type">PIN</span>
            ...
            <td class="description last"><p>the pin to set.</p></td>
        </tr>
...
<span class="param-type">LEVEL</span>
            ...
            <td class="description last"><p>the pin level to set.</p></td>
        </tr>
    ...
    <h4 class="name" id="setPinMode"><span class="type-signature"></span>setPinMode<span class="signature">(pin, mode)</span><span class="type-signature"></span></h4>
...
<span class="param-type">MODE</span>
            ...
            <td class="description last"><p>the pin mode to set.</p></td>
        </tr>
    ...
    <h4 class="name" id="setPwmOutput"><span class="type-signature"></span>setPwmOutput<span class="signature">(pin, value)</span><span class="type-signature"></span></h4>
...
<span class="param-type">VALUE</span>
            ...
            <td class="description last"><p>the pwm value to set.</p></td>
        </tr>
    ...
    <h4 class="name" id="setServoOutput"><span class="type-signature"></span>setServoOutput<span class="signature">(pin, value)</span><span class="type-signature"></span></h4>
...
<span class="param-type">VALUE</span>
            ...
            <td class="description last"><p>the degree to set.</p></td>
        </tr>
    ...
    <h4 class="name" id="upload"><span class="type-signature"></span>upload<span class="signature">(code)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Called by the runtime when user wants to upload code to a peripheral.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>the code want to upload.</p></td>
        </tr>
    ...
    <h4 class="name" id="uploadFirmware"><span class="type-signature"></span>uploadFirmware<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Called by the runtime when user wants to upload realtime firmware to a peripheral.</p>
</div>
    ...
    <h4 class="name" id="write"><span class="type-signature"></span>write<span class="signature">(data)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Write data to the peripheral serialport.</p>
</div>
