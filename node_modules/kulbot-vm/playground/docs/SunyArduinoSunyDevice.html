...
<head>
    ...
    <meta charset="utf-8">
    <title>SunyArduinoSunyDevice - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">SunyArduinoSunyDevice</h1>
...
<header>
        ...
        <h2>
        SunyArduinoSunyDevice
        </h2>
        
            <div class="class-description usertext"><p>Suny blocks to interact with a Arduino Uno peripheral.</p></div>
...
<article>
    ...
    <h4 class="name" id="SunyArduinoSunyDevice"><span class="type-signature"></span>new SunyArduinoSunyDevice<span class="signature">(runtime, originalDeviceId)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Construct a set of Arduino blocks.</p>
</div>
...
<h4 class="name" id=".DEVICE_ID"><span class="type-signature">(static) </span>DEVICE_ID<span class="type-signature"></span></h4>
...
<span class="param-type"><a href="Runtime.html">Runtime</a></span>
    ...
    <h4 class="name" id="eps32GetGas"><span class="type-signature"></span>eps32GetGas<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="param-desc">
    <ul>
<li>a Promise that resolves after the set Led out value is done.</li>
</ul>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32GetJoystick"><span class="type-signature"></span>eps32GetJoystick<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description usertext">
    <p>Initialize Joystick Sensor</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32GetSoilHum"><span class="type-signature"></span>eps32GetSoilHum<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32GetSonarSensor"><span class="type-signature"></span>eps32GetSonarSensor<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="param-desc">
    <ul>
<li>a Promise that resolves after the return Temperature mode is done.</li>
</ul>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32SGryro"><span class="type-signature"></span>eps32SGryro<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32SHum"><span class="type-signature"></span>eps32SHum<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32SLight"><span class="type-signature"></span>eps32SLight<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32SMotorM1"><span class="type-signature"></span>eps32SMotorM1<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="param-desc">
    <ul>
<li>a Promise that resolves after the set motor value is done.</li>
</ul>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32SServo"><span class="type-signature"></span>eps32SServo<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="param-desc">
    <ul>
<li>a Promise that resolves after the set servo out value is done.</li>
</ul>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32STemp"><span class="type-signature"></span>eps32STemp<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32STouch"><span class="type-signature"></span>eps32STouch<span class="signature">(args)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<div class="description usertext">
    <p>Read touch sensor digital level.</p>
</div>
...
<div class="param-desc">
    <ul>
<li>true if read high level, false if read low level.</li>
</ul>
</div>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="eps32SUltra"><span class="type-signature"></span>eps32SUltra<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="param-desc">
    <ul>
<li>a Promise that resolves after the return Ulstrasonic mode is done.</li>
</ul>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="eps32Volume"><span class="type-signature"></span>eps32Volume<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32lcdClear"><span class="type-signature"></span>esp32lcdClear<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32lcdNumber"><span class="type-signature"></span>esp32lcdNumber<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32lcdString"><span class="type-signature"></span>esp32lcdString<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32ledOn"><span class="type-signature"></span>esp32ledOn<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32OffAllLed"><span class="type-signature"></span>esp32OffAllLed<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32OffLed"><span class="type-signature"></span>esp32OffLed<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32OnAllLed"><span class="type-signature"></span>esp32OnAllLed<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32setButtonLed"><span class="type-signature"></span>esp32setButtonLed<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32setIRLed"><span class="type-signature"></span>esp32setIRLed<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="esp32setTrafficLight"><span class="type-signature"></span>esp32setTrafficLight<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getInfo"><span class="type-signature"></span>getInfo<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;object>}</span></h4>
...
<span class="param-type">Array.&lt;object></span>
    ...
    <h4 class="name" id="setServoOutput"><span class="type-signature"></span>setServoOutput<span class="signature">(args)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
