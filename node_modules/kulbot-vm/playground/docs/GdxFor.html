...
<head>
    ...
    <meta charset="utf-8">
    <title>GdxFor - Documentation</title>
...
<header>
        ...
        GdxFor
            ...
            <div class="class-description usertext"><p>Manage communication with a GDX-FOR peripheral over a Scratch Link client socket.</p></div>
...
<article>
    ...
    <h4 class="name" id="GdxFor"><span class="type-signature"></span>new GdxFor<span class="signature">(runtime, extensionId)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Construct a GDX-FOR communication object.</p>
</div>
...
<div class="description usertext">
    <p>The BluetoothLowEnergy connection socket for reading/writing peripheral data.</p>
</div>
...
<h4 class="name" id="_device"><span class="type-signature">(private) </span>_device<span class="type-signature"> :Device</span></h4>
...
<div class="description usertext">
    <p>An @vernier/godirect Device</p>
</div>
...
<div class="description usertext">
    <p>Starts reading data from peripheral after BLE has connected to it.</p>
</div>
    ...
    <h4 class="name" id="_onSensorValueChanged"><span class="type-signature">(private) </span>_onSensorValueChanged<span class="signature">(sensor)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Handler for sensor value changes from the goforce device.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>sensor</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>goforce device sensor whose value has changed</p></td>
        </tr>
...
<div class="description usertext">
    <p>Called by the runtime when a user exits the connection popup.
Disconnect from the GDX FOR.</p>
</div>
...
<div class="description usertext">
    <p>Return true if connected to the goforce device.</p>
</div>
...
<div class="param-desc">
    <ul>
<li>whether the goforce is connected.</li>
</ul>
</div>
