...
<head>
    ...
    <meta charset="utf-8">
    <title>ArduinoSuny - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ArduinoSuny</h1>
...
<header>
        ...
        ArduinoSuny
            ...
            <div class="class-description usertext"><p>Manage communication with a Arduino Uno peripheral over a Suny Link client socket.</p></div>
...
<article>
    ...
    <h4 class="name" id="ArduinoSuny"><span class="type-signature"></span>new ArduinoSuny<span class="signature">(runtime, deviceId, originalDeviceId)</span><span class="type-signature"></span></h4>
