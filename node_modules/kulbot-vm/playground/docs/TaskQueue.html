...
<head>
    ...
    <meta charset="utf-8">
    <title>TaskQueue - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">TaskQueue</h1>
...
<header>
        ...
        TaskQueue
            ...
            <div class="class-description usertext"><p>This class uses the token bucket algorithm to control a queue of tasks.</p></div>
...
<article>
    ...
    <h4 class="name" id="TaskQueue"><span class="type-signature"></span>new TaskQueue<span class="signature">(maxTokens, refillRate, options)</span><span class="type-signature"></span></h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>startingTokens</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the number of tokens the bucket starts with (default: <code>maxTokens</code>).</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>maxTotalCost</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>reject a task if total queue cost would pass this limit (default: no limit).</p></td>
        </tr>
...
<div class="description usertext">
    <p>Creates an instance of TaskQueue.
To allow bursts, set <code>maxTokens</code> to several times the average task cost.
To prevent bursts, set <code>maxTokens</code> to the cost of the largest tasks.
Note that tasks with a cost greater than <code>maxTokens</code> will be rejected.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>maxTokens</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the maximum number of tokens in the bucket (burst size).</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>refillRate</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the number of tokens to be added per second (sustain rate).</p></td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>optional settings for the new task queue instance.</p></td>
        </tr>
        ...
        <dl>
            <dt><a href="TaskQueue.html">TaskQueue</a></dt>
            <dd></dd>
        </dl>
...
<div class="description usertext">
    <p>Get the number of queued tasks which have not yet started.</p>
</div>
    ...
    <h4 class="name" id="_refill"><span class="type-signature"></span>_refill<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Refill the token bucket based on the amount of time since the last refill.</p>
</div>
    ...
    <h4 class="name" id="_refillAndSpend"><span class="type-signature"></span>_refillAndSpend<span class="signature">(cost)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="TaskQueue.html#_refill">TaskQueue#_refill</a></li>
        
            <li><a href="TaskQueue.html#_spend">TaskQueue#_spend</a></li>
        </ul>
    </dd>
...
<div class="description usertext">
    <p>Shorthand for calling _refill() then _spend(cost).</p>
</div>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the number of tokens to try to spend.</p></td>
        </tr>
...
<div class="param-desc">
    <p>true if we had enough tokens; false otherwise.</p>
</div>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="_runTasks"><span class="type-signature"></span>_runTasks<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Loop until the task queue is empty, running each task and spending tokens to do so.
Any time the bucket can't afford the next task, delay asynchronously until it can.</p>
</div>
    ...
    <h4 class="name" id="_spend"><span class="type-signature"></span>_spend<span class="signature">(cost)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<div class="description usertext">
    <p>If we can &quot;afford&quot; the given cost, subtract that many tokens and return true.
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="cancel"><span class="type-signature"></span>cancel<span class="signature">(taskPromise)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<div class="description usertext">
    <p>Cancel one pending task, rejecting its promise.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>taskPromise</code></td>
...
<span class="param-type">Promise</span>
            ...
            <td class="description last"><p>the promise returned by <code>do()</code>.</p></td>
        </tr>
...
<div class="param-desc">
    <ul>
<li>true if the task was found, or false otherwise.</li>
</ul>
</div>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="cancelAll"><span class="type-signature"></span>cancelAll<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Cancel all pending tasks, rejecting all their promises.</p>
</div>
    ...
    <h4 class="name" id="do"><span class="type-signature"></span>do<span class="signature">(task, cost<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description usertext">
    <p>Wait until the token bucket is full enough, then run the provided task.</p>
</div>
...
<span class="param-type">function</span>
            ...
            <td class="description last"><p>the task to run.</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the number of tokens this task consumes from the bucket.</p></td>
        </tr>
...
<div class="param-desc">
    <ul>
<li>a promise for the task's return value.</li>
</ul>
</div>
