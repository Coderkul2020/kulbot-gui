...
<head>
    ...
    <meta charset="utf-8">
    <title>RuntimeScriptCache - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">RuntimeScriptCache</h1>
...
<header>
        ...
        RuntimeScriptCache
            ...
            <div class="class-description usertext"><p>A set of cached data about the top block of a script.</p></div>
...
<article>
    ...
    <h4 class="name" id="RuntimeScriptCache"><span class="type-signature"></span>new RuntimeScriptCache<span class="signature">(container, blockId)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="Blocks.html">Blocks</a></span>
            ...
            <td class="description last"><p>Container holding the block and related data</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Id for whose block data is cached in this instance</p></td>
        </tr>
...
<h4 class="name" id="blockId"><span class="type-signature"></span>blockId<span class="type-signature"> :string</span></h4>
...
<div class="description usertext">
    <p>ID for block this instance caches.</p>
</div>
...
<h4 class="name" id="container"><span class="type-signature"></span>container<span class="type-signature"> :<a href="Blocks.html">Blocks</a></span></h4>
...
<div class="description usertext">
    <p>Container with block data for blockId.</p>
</div>
...
<h4 class="name" id="fieldsOfInputs"><span class="type-signature"></span>fieldsOfInputs<span class="type-signature"> :object</span></h4>
...
<div class="description usertext">
    <p>Formatted fields or fields of input blocks ready for comparison in
runtime.</p>
<p>This is a clone of parts of the targeted blocks. Changes to these
...
values will be compared later by the VM.</p>
</div>
