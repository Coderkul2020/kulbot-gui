...
<header>
        ...
        Scratch3MusicBlocks
            ...
            <div class="class-description usertext"><p>Class for the music-related blocks in Scratch 3.0</p></div>
...
<h4 class="name" id="MIDI_DRUMS"><span class="type-signature"></span>MIDI_DRUMS<span class="type-signature"> :Array.&lt;Array></span></h4>
...
<div class="description usertext">
    <p>An array that is a mapping from MIDI drum numbers in range (35..81) to Scratch drum numbers.
It's in the format [drumNum, pitch, decay].
The pitch and decay properties are not currently being used.</p>
</div>
...
<h4 class="name" id="MIDI_INSTRUMENTS"><span class="type-signature"></span>MIDI_INSTRUMENTS<span class="type-signature"> :Array.&lt;number></span></h4>
...
<div class="description usertext">
    <p>An array that is a mapping from MIDI instrument numbers to Scratch instrument numbers.</p>
</div>
...
<ul>
    ...
    <h4 class="name" id="_playDrumForBeats"><span class="type-signature"></span>_playDrumForBeats<span class="signature">(drumNum, beats, util)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Internal code to play a drum sound for some number of beats.</p>
</div>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the drum number.</p></td>
        </tr>
...
<span class="param-type">beats</span>
            ...
            <td class="description last"><p>the duration in beats to pause after playing the sound.</p></td>
        </tr>
...
<span class="param-type">index</span>
    ...
    <h4 class="name" id="_setInstrument"><span class="type-signature"></span>_setInstrument<span class="signature">(instNum, util, mapMidi)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Internal code to select an instrument for playing notes. If mapMidi is true, set the instrument according to
the MIDI to Scratch instrument mapping.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>instNum</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the instrument number.</p></td>
        </tr>
...
<span class="param-type">object</span>
        ...
        <tr>
                ...
                <td class="name"><code>mapMidi</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>whether or not instNum is a MIDI instrument number.</p></td>
        </tr>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="midiPlayDrumForBeats"><span class="type-signature"></span>midiPlayDrumForBeats<span class="signature">(args, util)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Play a drum sound for some number of beats according to the range of &quot;MIDI&quot; drum codes supported.
This block is implemented for compatibility with old Scratch projects that use the
'drum:duration:elapsed:from:' block.</p>
</div>
...
<span class="param-type">object</span>
    ...
    <h4 class="name" id="midiSetInstrument"><span class="type-signature"></span>midiSetInstrument<span class="signature">(args, util)</span><span class="type-signature"></span></h4>
...
<span class="param-type">int</span>
            ...
            <td class="description last"><p>the MIDI number of the instrument to select.</p></td>
        </tr>
...
<div class="description usertext">
    <p>Select an instrument for playing notes according to a mapping of MIDI codes to Scratch instrument numbers.
This block is implemented for compatibility with old Scratch projects that use the 'midiInstrument:' block.</p>
</div>
