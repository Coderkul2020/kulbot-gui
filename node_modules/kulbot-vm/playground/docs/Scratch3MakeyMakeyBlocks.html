...
<head>
    ...
    <meta charset="utf-8">
    <title>Scratch3MakeyMakeyBlocks - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Scratch3MakeyMakeyBlocks</h1>
...
<header>
        ...
        Scratch3MakeyMakeyBlocks
            ...
            <div class="class-description usertext"><p>Class for the makey makey blocks in Scratch 3.0</p></div>
...
<article>
    ...
    <h4 class="name" id="Scratch3MakeyMakeyBlocks"><span class="type-signature"></span>new Scratch3MakeyMakeyBlocks<span class="signature">()</span><span class="type-signature"></span></h4>
...
<h4 class="name" id="frameToggle"><span class="type-signature"></span>frameToggle<span class="type-signature"> :boolean</span></h4>
...
<div class="description usertext">
    <p>A toggle that alternates true and false each frame, so that an
edge-triggered hat can trigger on every other frame.</p>
</div>
...
<span class="param-type"><a href="Runtime.html">Runtime</a></span>
    ...
    <h4 class="name" id="_clearkeyPressBuffer"><span class="type-signature"></span>_clearkeyPressBuffer<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Clear the key press buffer.</p>
</div>
