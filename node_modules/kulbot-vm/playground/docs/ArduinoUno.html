...
<head>
    ...
    <meta charset="utf-8">
    <title>ArduinoUno - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ArduinoUno</h1>
...
<article>
    ...
    <h4 class="name" id="ArduinoUno"><span class="type-signature"></span>new ArduinoUno<span class="signature">(runtime, deviceId, originalDeviceId)</span><span class="type-signature"></span></h4>
