...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="createVariable"><span class="type-signature"></span>createVariable<span class="signature">(id, name, type, isCloud)</span><span class="type-signature"></span></h4>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Whether the variable to create has the isCloud flag set.
Additional checks are made that the variable can be created as a cloud variable.</p></td>
        </tr>
    ...
    <h4 class="name" id="deleteMonitors"><span class="type-signature"></span>deleteMonitors<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Remove this target's monitors from the runtime state and remove the
target-specific monitored blocks (e.g. local variables, global variables for the stage, x-position).
NOTE: This does not delete any of the stage monitors like backdrop name.</p>
</div>
...
<p>If a variable being referenced is local, and</p>
<ol>
<li>The receiving target is a sprite:
...
for the original variable to reference the new variable.</li>
<li>The receiving target is the stage:
Create a new global variable with a fresh name and update all the referencing
fields to reference the new variable.</li>
</ol>
</div>
