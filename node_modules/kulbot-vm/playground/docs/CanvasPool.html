...
<head>
    ...
    <meta charset="utf-8">
    <title>CanvasPool - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">CanvasPool</h1>
...
<header>
        ...
        CanvasPool
            ...
            <div class="class-description usertext"><p>A pool of canvas objects that can be reused to reduce memory
...
<article>
    ...
    <h4 class="name" id="CanvasPool"><span class="type-signature"></span>new CanvasPool<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>After a short wait period clear the pool to let the VM collect
garbage.</p>
</div>
    ...
    <h4 class="name" id="create"><span class="type-signature"></span>create<span class="signature">()</span><span class="type-signature"> &rarr; {HTMLCanvasElement}</span></h4>
...
<div class="description usertext">
    <p>Return a canvas. Create the canvas if the pool is empty.</p>
</div>
...
<span class="param-type">HTMLCanvasElement</span>
    ...
    <h4 class="name" id="release"><span class="type-signature"></span>release<span class="signature">(canvas)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Release the canvas to be reused.</p>
</div>
