...
<header>
        ...
        Blocks
            ...
            <div class="class-description usertext"><p>Create a block container.</p></div>
...
<article>
    ...
    <h4 class="name" id="Blocks"><span class="type-signature"></span>new Blocks<span class="signature">(runtime, optNoGlow)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="Runtime.html">Runtime</a></span>
            ...
            <td class="description last"><p>The runtime this block container operates within</p></td>
        </tr>
...
<span class="param-type">object</span>
    ...
    <h4 class="name" id="blocklyListen"><span class="type-signature"></span>blocklyListen<span class="signature">(e)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="changeBlock"><span class="type-signature"></span>changeBlock<span class="signature">(args<span class="signature-attributes">non-null</span>)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Emit a project changed event if this is a block container
that can affect the project state.</p>
</div>
    ...
    <h4 class="name" id="getAllIds"><span class="type-signature"></span>getAllIds<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;string>}</span></h4>
...
<span class="param-type">Array.&lt;string></span>
    ...
    <h4 class="name" id="getAllVariableAndListReferences"><span class="type-signature"></span>getAllVariableAndListReferences<span class="signature">(optBlocks, optIncludeBroadcast<span class="signature-attributes">nullable</span>)</span><span class="type-signature"> &rarr; {object}</span></h4>
...
of all blocks on the workspace</p></td>
        ...
        <tr>
                ...
                <td class="name"><code>optIncludeBroadcast</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Optional whether to include broadcast fields.</p></td>
        </tr>
...
<div class="description usertext">
    <p>Get names and ids of parameters for the given procedure.</p>
</div>
...
<span class="param-type">Array.&lt;string></span>
    ...
    <h4 class="name" id="getProcedureParamNamesIdsAndDefaults"><span class="type-signature"></span>getProcedureParamNamesIdsAndDefaults<span class="signature">(name<span class="signature-attributes">nullable</span>)</span><span class="type-signature"> &rarr; (nullable) {Array.&lt;string>}</span></h4>
...
<div class="description usertext">
    <p>Get names, ids, and defaults of parameters for the given procedure.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="updateSensingOfReference"><span class="type-signature"></span>updateSensingOfReference<span class="signature">(oldName, newName, targetName)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<div class="description usertext">
    <p>Update sensing_of blocks after a variable gets renamed.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The old name of the variable that was renamed.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The name of the target the variable belongs to.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Returns true if any of the blocks were updated.</p>
</div>
