...
<head>
    ...
    <meta charset="utf-8">
    <title>Scratch3CoreExample - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Scratch3CoreExample</h1>
...
<header>
        ...
        Scratch3CoreExample
            ...
            <div class="class-description usertext"><p>An example core block implemented using the extension spec.
This is not loaded as part of the core blocks in the VM but it is provided
and used as part of tests.</p></div>
...
<article>
    ...
    <h4 class="name" id="Scratch3CoreExample"><span class="type-signature"></span>new Scratch3CoreExample<span class="signature">()</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="Runtime.html">Runtime</a></span>
    ...
    <h4 class="name" id="exampleOpcode"><span class="type-signature"></span>exampleOpcode<span class="signature">()</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<div class="description usertext">
    <p>Example opcode just returns the name of the stage target.</p>
</div>
...
<div class="param-desc">
    <p>The name of the first target in the project.</p>
</div>
