...
<head>
    ...
    <meta charset="utf-8">
    <title>Boost - Documentation</title>
...
<header>
        ...
        Boost
            ...
            <div class="class-description usertext"><p>Manage communication with a Boost peripheral over a Bluetooth Low Energy client socket.</p></div>
...
<article>
    ...
    <h4 class="name" id="Boost"><span class="type-signature"></span>new Boost<span class="signature">()</span><span class="type-signature"></span></h4>
...
<h4 class="name" id="_ble"><span class="type-signature">(private) </span>_ble<span class="type-signature"> :<a href="BLE.html">BLE</a></span></h4>
...
<div class="description usertext">
    <p>The Bluetooth connection socket for reading/writing peripheral data.</p>
</div>
...
<span class="param-type"><a href="BLE.html">BLE</a></span>
...
<h4 class="name" id="_colorSamples"><span class="type-signature">(private) </span>_colorSamples<span class="type-signature"> :Array</span></h4>
...
<div class="description usertext">
    <p>An array of values from the Boost Vision Sensor.</p>
</div>
...
<h4 class="name" id="_extensionId"><span class="type-signature"></span>_extensionId<span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>The id of the extension this peripheral belongs to.</p>
</div>
...
<h4 class="name" id="_motors"><span class="type-signature">(private) </span>_motors<span class="type-signature"> :Array.&lt;<a href="BoostMotor.html">BoostMotor</a>></span></h4>
...
<div class="description usertext">
    <p>A list of motors registered by the Boost hardware.</p>
</div>
...
<span class="param-type">Array.&lt;<a href="BoostMotor.html">BoostMotor</a>></span>
...
<h4 class="name" id="_pingDeviceId"><span class="type-signature">(private) </span>_pingDeviceId<span class="type-signature"> :number</span></h4>
...
<div class="description usertext">
    <p>An interval id for the battery check interval.</p>
</div>
...
<div class="description usertext">
    <p>A list of the ids of the physical or virtual sensors.</p>
</div>
...
<h4 class="name" id="previousColor"><span class="type-signature"></span>previousColor<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id="_clearPort"><span class="type-signature">(private) </span>_clearPort<span class="signature">(portID)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Clear the sensors or motors present on the ports.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>portID</code></td>
...
<div class="description usertext">
    <p>Starts reading data from peripheral after BLE has connected.</p>
</div>
...
<span class="param-type">object</span>
    ...
    <h4 class="name" id="_pingDevice"><span class="type-signature">(private) </span>_pingDevice<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Ping the Boost hub. If the Boost hub has disconnected
...
close the socket.</p>
    ...
    <h4 class="name" id="_registerSensorOrMotor"><span class="type-signature">(private) </span>_registerSensorOrMotor<span class="signature">(portID, type)</span><span class="type-signature"></span></h4>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id="boostColorForIndex"><span class="type-signature"></span>boostColorForIndex<span class="signature">(index)</span><span class="type-signature"> &rarr; {<a href="global.html#BoostColor">BoostColor</a>}</span></h4>
...
<div class="description usertext">
    <p>Look up the color id for an index received from the vision sensor.</p>
</div>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the color index to look up.</p></td>
        </tr>
...
<div class="param-desc">
    <p>the color id for this index.</p>
</div>
...
<span class="param-type"><a href="global.html#BoostColor">BoostColor</a></span>
    ...
    <h4 class="name" id="connect"><span class="type-signature"></span>connect<span class="signature">(id)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Called by the runtime when user wants to connect to a certain Boost peripheral.</p>
</div>
...
<div class="description usertext">
    <p>Disconnects from the current BLE socket and resets state.</p>
</div>
    ...
    <h4 class="name" id="generateInputCommand"><span class="type-signature"></span>generateInputCommand<span class="signature">(portID, mode, delta, enableNotifications)</span><span class="type-signature"> &rarr; {array}</span></h4>
...
<div class="description usertext">
    <p>Generate a Boost 'Input Command' in the byte array format
(COMMAND ID, COMMAND TYPE, CONNECT ID, TYPE ID, MODE, DELTA INTERVAL (4 BYTES),
UNIT, NOTIFICATIONS ENABLED).</p>
<p>This sends a command to the Boost that sets that input format
of the specified inputs and sets value change notifications.</p>
</div>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the port (Connect ID) to send a command to.</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the mode of the input sensor.</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the delta change needed to trigger notification.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>enableNotifications</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>whether to enable notifications.</p></td>
        </tr>
...
<div class="param-desc">
    <ul>
<li>a generated input command.</li>
</ul>
</div>
...
<span class="param-type">array</span>
    ...
    <h4 class="name" id="generateOutputCommand"><span class="type-signature"></span>generateOutputCommand<span class="signature">(portID, execution, subCommand, payload)</span><span class="type-signature"> &rarr; {array}</span></h4>
...
<div class="description usertext">
    <p>Generate a Boost 'Output Command' in the byte array format
(COMMON HEADER, PORT ID, EXECUTION BYTE, SUBCOMMAND ID, PAYLOAD).</p>
<p>Payload is accepted as an array since these vary across different subcommands.</p>
</div>
...
<span class="param-type">number</span>
        ...
        <tr>
                ...
                <td class="name"><code>execution</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Byte containing startup/completion information</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>the id of the subcommand byte.</p></td>
        </tr>
...
<span class="param-type">array</span>
            ...
            <td class="description last"><p>the list of bytes to send as subcommand payload</p></td>
        </tr>
...
<div class="param-desc">
    <ul>
<li>a generated output command.</li>
</ul>
</div>
...
<div class="description usertext">
    <p>Called by the runtime to detect whether the Boost peripheral is connected.</p>
</div>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="motor"><span class="type-signature"></span>motor<span class="signature">(index)</span><span class="type-signature"> &rarr; {<a href="BoostMotor.html">BoostMotor</a>}</span></h4>
...
<div class="description usertext">
    <p>Access a particular motor on this peripheral.</p>
</div>
...
<span class="param-type">int</span>
            ...
            <td class="description last"><p>the index of the desired motor.</p></td>
        </tr>
...
<div class="param-desc">
    <ul>
<li>the BoostMotor instance, if any, at that index.</li>
</ul>
</div>
...
<span class="param-type"><a href="BoostMotor.html">BoostMotor</a></span>
...
<div class="description usertext">
    <p>Called by the runtime when user wants to scan for a Boost peripheral.</p>
</div>
    ...
    <h4 class="name" id="send"><span class="type-signature"></span>send<span class="signature">(uuid, message, useLimiter<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description usertext">
    <p>Write a message to the Boost peripheral BLE socket.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="setLED"><span class="type-signature"></span>setLED<span class="signature">(inputRGB)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description usertext">
    <p>Set the Boost peripheral's LED to a specific color.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>inputRGB</code></td>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="setLEDMode"><span class="type-signature"></span>setLEDMode<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description usertext">
    <p>Stop the motors on the Boost peripheral.</p>
</div>
