...
<head>
    ...
    <meta charset="utf-8">
    <title>ScratchLinkWebSocket - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ScratchLinkWebSocket</h1>
...
<header>
        ...
        ScratchLinkWebSocket
            ...
            <div class="class-description usertext"><p>This class provides a ScratchLinkSocket implementation using WebSockets,
attempting to connect with the locally installed Scratch-Link.</p>
<p>To connect with ScratchLink without WebSockets, you must implement all of the
public methods in this class.</p>
<ul>
<li>open()</li>
<li>close()</li>
<li>setOn[Open|Close|Error]</li>
<li>setHandleMessage</li>
<li>sendMessage(msgObj)</li>
<li>isOpen()</li>
</ul></div>
...
<article>
    ...
    <h4 class="name" id="ScratchLinkWebSocket"><span class="type-signature"></span>new ScratchLinkWebSocket<span class="signature">()</span><span class="type-signature"></span></h4>
