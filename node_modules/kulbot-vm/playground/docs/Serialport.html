...
<head>
    ...
    <meta charset="utf-8">
    <title>Serialport - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Serialport</h1>
...
<article>
    ...
    <h4 class="name" id="Serialport"><span class="type-signature"></span>new Serialport<span class="signature">(runtime, deviceId, peripheralOptions, connectCallback, resetCallback)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>A serialport peripheral socket object.  It handles connecting, over web sockets, to
serialport peripherals, and reading and writing data to them.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>the id of the device using this socket.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>peripheralOptions</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>the list of options for peripheral discovery.</p></td>
        </tr>
...
<span class="param-type">object</span>
        ...
        <tr>
                ...
                <td class="name"><code>resetCallback</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>a callback for resetting extension state.</p></td>
        </tr>
    ...
    <h4 class="name" id="connectPeripheral"><span class="type-signature"></span>connectPeripheral<span class="signature">(id, config)</span><span class="type-signature"></span></h4>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>communacation configuration of peripheral</p></td>
        </tr>
...
<div class="description usertext">
    ...
    <h4 class="name" id="handleDisconnectError"><span class="type-signature"></span>handleDisconnectError<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Handle an error resulting from losing connection to a peripheral.</p>
<p>This could be due to:</p>
<ul>
<li>battery depletion</li>
<li>going out of bluetooth range</li>
<li>being powered down</li>
</ul>
<p>Disconnect the socket, and if the extension using this socket has a
reset callback, call it. Finally, emit an error to the runtime.</p>
</div>
    ...
    <h4 class="name" id="handleRealtimeDisconnectError"><span class="type-signature"></span>handleRealtimeDisconnectError<span class="signature">(e)</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Handle an error resulting from losing connection to a peripheral realtime protocal.</p>
<p>This could be due to:</p>
<ul>
<li>peripheral didn't running the realtime protocal like firmata.</li>
<li>peripheral is not running.</li>
</ul>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="isConnected"><span class="type-signature"></span>isConnected<span class="signature">()</span><span class="type-signature"> &rarr; {bool}</span></h4>
...
<span class="param-type">bool</span>
    ...
    <h4 class="name" id="read"><span class="type-signature"></span>read<span class="signature">(onMessage)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="requestPeripheral"><span class="type-signature"></span>requestPeripheral<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description usertext">
    <p>Request connection to the peripheral.
If the web socket is not yet open, request when the socket promise resolves.</p>
    ...
    <h4 class="name" id="upload"><span class="type-signature"></span>upload<span class="signature">(message, config, encoding)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description usertext">
    <p>Upload code to the peripheral.</p>
</div>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>the configuration of upload process.</p></td>
        </tr>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="uploadFirmware"><span class="type-signature"></span>uploadFirmware<span class="signature">(config)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description usertext">
    <p>Upload realtime firmware to the peripheral.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="write"><span class="type-signature"></span>write<span class="signature">(message, encoding)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description usertext">
    <p>Write data to the serialport.</p>
</div>
