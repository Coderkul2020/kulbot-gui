...
Blockly.Python.variableDB_.setVariableMap(a.getVariableMap());var b=[];a=Blockly.Variables.allVariables(a);for(var c=0;c<a.length;c++)b[c]=Blockly.Python.variableDB_.getName(a[c].name,Blockly.Variables.NAME_TYPE)+" = 0";0<a.length&&(Blockly.Python.variables_.variables=b.join("\n"))};
Blockly.Python.finish=function(a){var b=[];for(e in Blockly.Python.imports_)b.push(Blockly.Python.imports_[e]);var c=[];for(e in Blockly.Python.customFunctions_)c.push(Blockly.Python.customFunctions_[e]);var d=[];for(e in Blockly.Python.libraries_)d.push(Blockly.Python.libraries_[e]);var f=[];for(e in Blockly.Python.variables_)f.push(Blockly.Python.variables_[e]);var g=[];for(e in Blockly.Python.setups_)g.push(Blockly.Python.setups_[e]);var h=[];for(e in Blockly.Python.loops_)h.push(Blockly.Python.loops_[e]);
var e="# generated by Suny\n";0!=b.length&&(e+=b.join("\n")+"\n\n");0!=c.length&&(e+=c.join("\n\n")+"\n\n");0!=d.length&&(e+=d.join("\n")+"\n\n");0!=f.length&&(e+=f.join("\n")+"\n\n");0!=g.length&&(e+=g.join("\n")+"\n\n");e+=a+"\n";if(0!=h.length)Blockly.Python.firstLoop&&(e+="while True:\n"+Blockly.Python.INDENT+"repeat()\n\n",e=e.replace(/\npass\n/g,"")),e+="def repeat():\n"+Blockly.Python.INDENT,e+=h.join("\n"+Blockly.Python.INDENT)+"\n\n";else{a=e.match(/:\n *repeat\(\)\n/g);for(var k in a)b=
a[k].match(/\s+/g)[0].length,e=e.replace(/:\n *repeat\(\)\n/,":\n"+" ".repeat(b)+"pass\n");e=e.replace(/ *repeat\(\)\n/g,"")}delete Blockly.Python.imports_;delete Blockly.Python.libraries_;delete Blockly.Python.variables_;delete Blockly.Python.setups_;delete Blockly.Python.loops_;delete Blockly.Python.customFunctions_;delete Blockly.Python.customFunctionsArgName_;Blockly.Python.variableDB_.reset();Blockly.Python.firstLoop=!0;return e};
Blockly.Python.scrub_=function(a,b){if(null===b||!Blockly.Python.check_(a))return"";var c="";if(!a.outputConnection||!a.outputConnection.targetConnection){var d=a.getCommentText();d&&(c+=Blockly.Python.prefixLines(d,"# ")+"\n");for(var f=0;f<a.inputList.length;f++)a.inputList[f].type==Blockly.INPUT_VALUE&&(d=a.inputList[f].connection.targetBlock())&&(d=Blockly.Python.allNestedComments(d))&&(c+=Blockly.Python.prefixLines(d,"# "))}f=b;null===a.getSurroundParent()&&""!==b&&null!==a.previousConnection&&
"event_whenmicrobitbegin"!==a.getTopStackBlock().type&&("procedures_definition"!==a.type&&"procedures_prototype"!==a.type&&(f=Blockly.Arduino.INDENT+f,""!==c&&(c=Blockly.Arduino.INDENT+c)),f=f.replace(/\n/g,"\n"+Blockly.Arduino.INDENT),f=f.slice(0,f.length-2));a=a.nextConnection&&a.nextConnection.targetBlock();a=Blockly.Python.blockToCode(a);return c+f+a};Blockly.Python.scrubNakedValue=function(a){return a+";\n"};
Blockly.Python.quote_=function(a){a=a.replace(/\\/g,"\\\\").replace(/\n/g,"\\\n").replace(/%/g,"\\%").replace(/'/g,"\\'");return"'"+a+"'"};Blockly.Python.check_=function(a){return null===a.getSurroundParent()&&(null!==a.previousConnection&&null!==a.getTopStackBlock().previousConnection||2===a.getOutputShape()||1===a.getOutputShape())?!1:!0};Blockly.Python.colour={};Blockly.Python.colour_picker=function(a){return[a.getFieldValue("COLOUR"),Blockly.Python.ORDER_ATOMIC]};Blockly.Python.control={};Blockly.Python.control_wait=function(a){return"sleep("+Blockly.Python.valueToCode(a,"DURATION",Blockly.Python.ORDER_FUNCTION_CALL)+" * 1000)\n"};Blockly.Python.control_repeat=function(a){var b=Blockly.Python.valueToCode(a,"TIMES",Blockly.Python.ORDER_FUNCTION_CALL),c=Blockly.Python.statementToCode(a,"SUBSTACK");c=Blockly.Python.addLoopTrap(c,a.id);a="for count in range("+b+"):\n";return a=c?a+c:a+(Blockly.Python.INDENT+"pass\n")};
Blockly.Python.control_forever=function(a){var b=Blockly.Python.statementToCode(a,"SUBSTACK");b=Blockly.Python.addLoopTrap(b,a.id);Blockly.Python.firstLoop=!1;return"while True:\n"+b+(Blockly.Python.INDENT+"repeat()\n")};Blockly.Python.control_if=function(a){var b=Blockly.Python.valueToCode(a,"CONDITION",Blockly.Python.ORDER_NONE)||"False",c=Blockly.Python.statementToCode(a,"SUBSTACK");c=Blockly.Python.addLoopTrap(c,a.id);a="if "+b+":\n";return a=c?a+c:a+(Blockly.Python.INDENT+"pass\n")};
...
Blockly.Python.data_changevariableby=function(a){var b=Blockly.Python.valueToCode(a,"VALUE",Blockly.Python.ORDER_ADDITIVE)||"0";a=Blockly.Python.variableDB_.getName(a.getFieldValue("VARIABLE"),Blockly.Variables.NAME_TYPE);b=parseFloat(b).toString();return a+" += "+b+"\n"};Blockly.Python.data_showvariable=function(){return""};Blockly.Python.data_hidevariable=function(){return""};Blockly.Python.data_listcontents=function(){return""};Blockly.Python.data_listindexall=function(){return""};
Blockly.Python.data_listindexrandom=function(){return""};Blockly.Python.data_addtolist=function(){return""};Blockly.Python.data_deleteoflist=function(){return""};Blockly.Python.data_deletealloflist=function(){return""};Blockly.Python.data_insertatlist=function(){return""};Blockly.Python.data_replaceitemoflist=function(){return""};Blockly.Python.data_itemoflist=function(){return""};Blockly.Python.data_itemnumoflist=function(){return""};Blockly.Python.data_lengthoflist=function(){return""};
Blockly.Python.data_listcontainsitem=function(){return""};Blockly.Python.data_showlist=function(){return""};Blockly.Python.data_hidelist=function(){return""};Blockly.Python.event={};Blockly.Python.event_whenmicrobitbegin=function(a){Blockly.Python.imports_.microbit="from microbit import *";var b="";a.nextConnection&&a.nextConnection.targetBlock()||(b+="pass\n");return b};
Blockly.Python.event_whenmicrobitbuttonpressed=function(a){Blockly.Python.imports_.microbit="from microbit import *";for(var b=a.getFieldValue("KEY_OPTION"),c="";Blockly.Python.loops_["event_whenmicrobitbegin"+b+c];)""===c?c=1:c++;Blockly.Python.loops_["event_whenmicrobitbegin"+b+c]="if button_"+b+".is_pressed():\n"+Blockly.Python.INDENT+Blockly.Python.INDENT+"on_button_"+b+c+"()";b="def on_button_"+b+c+"():\n";a.nextConnection&&a.nextConnection.targetBlock()||(b+=Blockly.Python.INDENT+"pass\n");
return b};
Blockly.Python.event_whenmicrobitpinbeingtouched=function(a){Blockly.Python.imports_.microbit="from microbit import *";for(var b=a.getFieldValue("PIN_OPTION"),c="";Blockly.Python.loops_["event_whenmicrobitpinbeingtouched"+b+c];)""===c?c=1:c++;Blockly.Python.loops_["event_whenmicrobitpinbeingtouched"+b+c]="if pin"+b+".is_pressed():\n"+Blockly.Python.INDENT+Blockly.Python.INDENT+"on_pin"+b+c+"()";b="def on_pin"+b+c+"():\n";a.nextConnection&&a.nextConnection.targetBlock()||(b+=Blockly.Python.INDENT+"pass\n");
return b};
Blockly.Python.event_whenmicrobitgesture=function(a){Blockly.Python.imports_.microbit="from microbit import *";for(var b=a.getFieldValue("GESTURE_OPTION"),c="";Blockly.Python.loops_["event_whenmicrobitgesture"+b+c];)""===c?c=1:c++;Blockly.Python.loops_["event_whenmicrobitgesture"+b+c]="if accelerometer.was_gesture('"+b+"'):\n"+Blockly.Python.INDENT+Blockly.Python.INDENT+"on_"+b+c+"()";b="def on_"+b+c+"():\n";a.nextConnection&&a.nextConnection.targetBlock()||(b+=Blockly.Python.INDENT+"pass\n");return b};Blockly.Python.math={};Blockly.Python.math_number=function(a){a=parseFloat(a.getFieldValue("NUM"));isNaN(a)&&(a=0);return[a,0>a?Blockly.Python.ORDER_UNARY_SIGN:Blockly.Python.ORDER_ATOMIC]};Blockly.Python.math_integer=Blockly.Python.math_number;Blockly.Python.math_whole_number=Blockly.Python.math_number;Blockly.Python.math_positive_number=Blockly.Python.math_number;Blockly.Python.math_angle=Blockly.Python.math_number;Blockly.Python.math_int8_number=Blockly.Python.math_number;
Blockly.Python.math_uint8_number=Blockly.Python.math_number;Blockly.Python.math_int9_number=Blockly.Python.math_number;Blockly.Python.math_uint10_number=Blockly.Python.math_number;Blockly.Python.math_int11_number=Blockly.Python.math_number;Blockly.Python.matrix={};Blockly.Python.matrix=function(a){a=a.getFieldValue("MATRIX");isNaN(a)&&(a=0);return[a,Blockly.Python.ORDER_ATOMIC]};Blockly.Python.microbit={};Blockly.Python.microbit_pin_setDigitalOutput=function(a){var b=a.getFieldValue("PIN");a=Blockly.Python.valueToCode(a,"LEVEL",Blockly.Python.ORDER_UNARY_POSTFIX)||"LOW";return"pin"+b+".write_digital("+a+")\n"};Blockly.Python.microbit_pin_menu_level=function(a){return[a.getFieldValue("level")||"0",Blockly.Python.ORDER_ATOMIC]};
Blockly.Python.microbit_pin_setPwmOutput=function(a){var b=a.getFieldValue("PIN");a=Blockly.Python.valueToCode(a,"OUT",Blockly.Python.ORDER_UNARY_POSTFIX)||"0";return"pin"+b+".write_analog("+a+")\n"};Blockly.Python.microbit_pin_readDigitalPin=function(a){return["pin"+(a.getFieldValue("PIN")||"0")+".read_digital()",Blockly.Python.ORDER_ATOMIC]};Blockly.Python.microbit_pin_readAnalogPin=function(a){return["pin"+(a.getFieldValue("PIN")||"0")+".read_analog()",Blockly.Python.ORDER_ATOMIC]};
...
Blockly.Python.microbit_display_showOnPiexlbrightness=function(a){var b=a.getFieldValue("BRT"),c=Blockly.Python.valueToCode(a,"X",Blockly.Python.ORDER_FUNCTION_CALL)||"";a=Blockly.Python.valueToCode(a,"Y",Blockly.Python.ORDER_FUNCTION_CALL)||"";return"display.set_pixel(int("+c+"), int("+a+"), "+b+")\n"};Blockly.Python.microbit_sensor_menu_ledBrightness=function(a){return[a.getFieldValue("ledBrightness")||"0",Blockly.Python.ORDER_ATOMIC]};
...
Blockly.Python.procedures_prototype=function(a){var b=a.getProcCode();a=a.displayNames_;var c=[];b=b.replace(/ /g,"_");for(var d=0;d<a.length;d++){var f=b.charAt(b.indexOf("%")+1),g=Blockly.Python.variableDB_.getName(a[d],Blockly.Procedures.NAME_TYPE);Blockly.Python.customFunctionsArgName_[a[d]]=g;b="n"===f?b.replace("%n","N"):"s"===f?b.replace("%s","S"):b.replace("%b","B");c.push(g)}b=Blockly.Python.variableDB_.getName(b,Blockly.Procedures.NAME_TYPE);return"def "+b+"("+c.join(", ")+")"};
