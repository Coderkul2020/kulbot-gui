...
Blockly.Arduino.finish=function(a){var b=[];for(f in Blockly.Arduino.includes_)b.push(Blockly.Arduino.includes_[f]);var c=[];for(f in Blockly.Arduino.definitions_)c.push(Blockly.Arduino.definitions_[f]);var d=[];for(f in Blockly.Arduino.customFunctions_)d.push(Blockly.Arduino.customFunctions_[f]);var e=[];for(f in Blockly.Arduino.setups_)e.push(Blockly.Arduino.setups_[f]);var g=[];for(f in Blockly.Arduino.loops_)g.push(Blockly.Arduino.loops_[f]);var f="// generated by Code\n";0!=b.length&&(f+=b.join("\n")+
"\n\n");0!=c.length&&(f+=c.join("\n")+"\n\n");0!=d.length&&(f+=d.join("\n\n")+"\n\n");f+="void setup() {\n";0!=e.length&&(f+=Blockly.Arduino.INDENT+e.join("\n"+Blockly.Arduino.INDENT)+"\n");f=f+"}\nvoid loop() {\n"+a+"}\n";0!=g.length?(f=f+"\nvoid repeat() {\n"+(Blockly.Arduino.INDENT+g.join("\n"+Blockly.Arduino.INDENT)+"\n"),f+="}\n"):f=f.replace(/ *repeat\(\);\n/g,"");delete Blockly.Arduino.definitions_;delete Blockly.Arduino.includes_;delete Blockly.Arduino.customFunctions_;delete Blockly.Arduino.customFunctionsArgName_;
delete Blockly.Arduino.setups_;delete Blockly.Arduino.loop_;Blockly.Arduino.variableDB_.reset();Blockly.Arduino.firstLoop=!0;return f};
...
Blockly.Arduino.quote_=function(a){a=a.replace(/\\/g,"\\\\").replace(/\n/g,"\\\n").replace(/\$/g,"\\$").replace(/'/g,"\\'");return'"'+a+'"'};Blockly.Arduino.check_=function(a){return null===a.getSurroundParent()&&(null!==a.previousConnection&&null!==a.getTopStackBlock().previousConnection||2===a.getOutputShape()||1===a.getOutputShape())?!1:!0};Blockly.Arduino.arduino={};Blockly.Arduino.arduino_pin_setPinMode=function(a){var b=a.getFieldValue("PIN")||"0";a=a.getFieldValue("MODE")||"INPUT";Blockly.Arduino.setups_["setups_int"+b]="pinMode("+b+", "+a+");\n";return""};Blockly.Arduino.arduino_pin_setDigitalOutput=function(a){var b=a.getFieldValue("PIN")||"0";a=Blockly.Arduino.valueToCode(a,"LEVEL",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"LOW";Blockly.Arduino.setups_["setups_int"+b]="pinMode("+b+",  OUTPUT );\n";return"digitalWrite("+b+", "+a+");\n"};
Blockly.Arduino.arduino_pin_DigitalOutput=function(a){var b=a.getFieldValue("PIN")||"0";a=Blockly.Arduino.valueToCode(a,"LEVEL",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"LOW";Blockly.Arduino.setups_["setups_int"+b]="pinMode("+b+",  OUTPUT );\n";return"digitalWrite("+b+", "+a+");\n"};Blockly.Arduino.arduino_pin_menu_level=function(a){return[a.getFieldValue("level")||"LOW",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_setPwmOutput=function(a){var b=a.getFieldValue("PIN")||"0";a=Blockly.Arduino.valueToCode(a,"OUT",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;Blockly.Arduino.setups_["setups_int"+b]="pinMode("+b+",  OUTPUT );\n";return"analogWrite("+b+", "+a+");\n"};Blockly.Arduino.arduino_pin_readDigitalPin=function(a){return["digitalRead("+(a.getFieldValue("PIN")||"0")+")",Blockly.Arduino.ORDER_ATOMIC]};
...
Blockly.Arduino.arduino_pin_detachInterrupt=function(a){return"detachInterrupt(digitalPinToInterrupt("+(a.getFieldValue("PIN")||"2")+");\n"};Blockly.Arduino.arduino_serial_serialBegin=function(a){a=a.getFieldValue("VALUE")||"9600";Blockly.Arduino.setups_["setups_serial"+a]="Serial.begin("+a+");\n";return""};
Blockly.Arduino.arduino_serial_serialPrint=function(a){var b=Blockly.Arduino.valueToCode(a,"VALUE",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"";return"warp"===(a.getFieldValue("EOL")||"warp")?"Serial.println("+b+");\n":"Serial.print("+b+");\n"};Blockly.Arduino.arduino_serial_serialAvailable=function(){return["Serial.available()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_serial_serialReadData=function(){return["Serial.read()",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_serial_multiSerialBegin=function(a){var b=a.getFieldValue("NO")||"0";a=a.getFieldValue("VALUE")||"9600";"0"===b&&(b="");return"Serial"+b+".begin("+a+");\n"};Blockly.Arduino.arduino_serial_multiSerialPrint=function(a){var b=a.getFieldValue("NO")||"0";a=Blockly.Arduino.valueToCode(a,"VALUE",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"";"0"===b&&(b="");return"Serial"+b+".println("+a+");\n"};
Blockly.Arduino.arduino_serial_multiSerialAvailable=function(a){a=a.getFieldValue("NO")||"0";"0"===a&&(a="");return["Serial"+a+".available()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_serial_multiSerialReadAByte=function(a){a=a.getFieldValue("NO")||"0";"0"===a&&(a="");return["Serial"+a+".read()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_sensor_runningTime=function(){return["millis()",Blockly.Arduino.ORDER_ATOMIC]};
...
Blockly.Arduino.data_changevariableby=function(a){var b=Blockly.Arduino.valueToCode(a,"VALUE",Blockly.Arduino.ORDER_ASSIGNMENT)||"0";a=Blockly.Arduino.variableDB_.getName(a.getFieldValue("VARIABLE"),Blockly.Variables.NAME_TYPE);b=parseFloat(b).toString();return a+" += "+b+";\n"};Blockly.Arduino.data_showvariable=function(){return""};Blockly.Arduino.data_hidevariable=function(){return""};Blockly.Arduino.data_listcontents=function(){return""};Blockly.Arduino.data_listindexall=function(){return""};
...
return"void "+b+"("+c.join(", ")+")"};Blockly.Arduino.argument_reporter_boolean=function(a){a=a.getFieldValue("VALUE");return[Blockly.Arduino.customFunctionsArgName_[a],Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.argument_reporter_number=function(a){a=a.getFieldValue("VALUE");return[Blockly.Arduino.customFunctionsArgName_[a],Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.argument_reporter_string=function(a){a=a.getFieldValue("VALUE");return[Blockly.Arduino.customFunctionsArgName_[a],Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.suny={};Blockly.Arduino.event_whenkulbotbegin=function(){Blockly.Arduino.includes_.arduino_1="#include <Arduino.h>";return""};
Blockly.Arduino.arduino_display_esp32lcdString=function(a){var b=a.getFieldValue("PORT")||"1",c=Blockly.Arduino.valueToCode(a,"COL",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0,d=Blockly.Arduino.valueToCode(a,"CEL",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;a=Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"Hello!!!";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_LCD_INIT("+b+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_LCD_INIT("+b+");\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT()")&&
(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");0>c?c=0:16<c&&(c=16);0>d?d=0:1<d&&(d=1);return"Rob.KULBOT_LCD_PRINT_STRING("+b+","+c+","+d+","+a+");\n"};
Blockly.Arduino.arduino_display_esp32lcdNumber=function(a){var b=a.getFieldValue("PORT")||"1",c=Blockly.Arduino.valueToCode(a,"COL",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0,d=Blockly.Arduino.valueToCode(a,"CEL",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;a=Blockly.Arduino.valueToCode(a,"NUMBER",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_LCD_INIT("+b+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_LCD_INIT("+b+");\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT()")&&
(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");0>c?c=0:16<c&&(c=16);0>d?d=0:1<d&&(d=1);return"Rob.KULBOT_LCD_PRINT_NUMBER("+b+","+c+","+d+","+a+");\n"};
Blockly.Arduino.arduino_pin_esp32setTrafficLight=function(a){var b=a.getFieldValue("PORT")||"1",c=a.getFieldValue("COLOR")||"0";a=a.getFieldValue("STATUS")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_TRAFFIC_LIGHT_INIT("+b+");\n")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_TRAFFIC_LIGHT_INIT("+b+");\n");return"Rob.KULBOT_SET_TRAFFIC_LIGHT("+
b+","+c+","+a+");\n"};Blockly.Arduino.arduino_pin_eps32ButtonLed=function(a){var b=a.getFieldValue("PIN")||"1";a=a.getFieldValue("BUTTON")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_BUTTON_LED_INIT("+b+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_BUTTON_LED_INIT("+b+");\n");return["Rob.KULBOT_GET_BUTTON_LED("+b+","+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_sensor_eps32SGryro=function(a){var b=a.getFieldValue("PORT")||"0";a=a.getFieldValue("DATA")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_GRYRO_SENSOR_INIT("+b+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_GRYRO_SENSOR_INIT("+b+");\n");return["Rob.KULBOT_GET_GRYRO_SENSOR("+b+","+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_sensor_eps32GetSoilHum=function(a){a=a.getFieldValue("PORT")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SOIL_HUM_SENSOR_INIT("+a+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SOIL_HUM_SENSOR_INIT("+a+");\n");return["Rob.KULBOT_GET_SOIL_HUM_SENSOR("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_sensor_eps32SHum=function(a){a=a.getFieldValue("PORT")||"1";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_DHT_SENSOR_INIT("+a+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_DHT_SENSOR_INIT("+a+");\n");return["Rob.KULBOT_GET_HUM_DHT_SENSOR("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_esp32OffLed=function(a){a=a.getFieldValue("PORT")||"1";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_RGB_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_RGB_INIT(100);\n");return"Rob.KULBOT_RGB_OFF("+a+");\n"};
Blockly.Arduino.arduino_pin_esp32OnAllLed=function(a){a=a.getFieldValue("COLOR")||"-1";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_RGB_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_RGB_INIT(100);\n");var b="";"-1"!=a&&(b="Rob.KULBOT_RGB_ALL_ON("+a+");\n");return b};Blockly.Arduino.arduino_pin_esp32OffAllLed=function(a){-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_RGB_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_RGB_INIT(100);\n");return"Rob.KULBOT_RGB_ALL_OFF();\n"};
Blockly.Arduino.arduino_pin_esp32ledOnOF=function(a){var b=Blockly.Arduino.valueToCode(a,"LEVEL",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"HIGH";a=a.getFieldValue("COLOR")||"-1";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_RGB_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_RGB_INIT();\n");var c="";"HIGH"==b&&-1!=a&&(c="Rob.SetAllLed("+a+");\n");return c};
Blockly.Arduino.arduino_pin_esp32ledOn=function(a){var b=a.getFieldValue("PIN")||"1";a=a.getFieldValue("COLOR")||"-1";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_RGB_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_RGB_INIT(100);\n");var c="";-1!=a&&(c="Rob.KULBOT_RGB_ON("+b+","+a+");\n");return c};
Blockly.Arduino.arduino_sensor_eps32SUltra=function(a){a=a.getFieldValue("PIN")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");return["Rob.KULBOT_GET_SONAR_SENSOR("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32Volume=function(a){a=a.getFieldValue("PIN")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_VOLUME_INIT("+a+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_VOLUME_INIT("+a+");\n");return["Rob.KULBOT_GET_VOLUME_SENSOR("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32SLight=function(a){a=a.getFieldValue("PIN")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_LIGHT_SENSOR_INIT("+a+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_LIGHT_SENSOR_INIT("+a+");\n");return["Rob.KULBOT_GET_LIGHT_SENSOR("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_sensor_eps32STemp=function(a){a=a.getFieldValue("PIN")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_DHT_SENSOR_INIT("+a+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_DHT_SENSOR_INIT("+a+");\n");return["Rob.KULBOT_GET_TEMP_DHT_SENSOR("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32GetJoystick=function(a){var b=a.getFieldValue("PORT")||"0";a=a.getFieldValue("TYPE")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_JOYSTICK_SENSOR_INIT("+b+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_JOYSTICK_SENSOR_INIT("+b+");\n");return["Rob.KULBOT_GET_JOYSTICK_SENSOR("+b+","+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_sensor_eps32GetGas=function(a){a=a.getFieldValue("PORT")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_GAS_SENSOR_INIT("+a+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_GAS_SENSOR_INIT("+a+");\n");return["Rob.KULBOT_GET_GAS_SENSOR("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_sensor_eps32STouch=function(a){a=a.getFieldValue("PIN")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_TOUCH_SENSOR_INIT("+a+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_TOUCH_SENSOR_INIT("+a+");\n");return["Rob.KULBOT_GET_TOUCH_SENSOR("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_sensor_eps32SLine=function(a){var b=a.getFieldValue("PIN")||"0";a=a.getFieldValue("VLE")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_LINE_SENSOR_INIT("+b+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_LINE_SENSOR_INIT("+b+");\n");return["Rob.KULBOT_GET_LINE_SENSOR("+b+","+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_sensor_eps32SIR=function(a){a=a.getFieldValue("PIN")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_IR_SENSOR_INIT("+a+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_IR_SENSOR_INIT("+a+");\n");return["Rob.KULBOT_GET_IR_SENSOR("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_esp32setIRLed=function(a){var b=a.getFieldValue("PORT")||"1";a=a.getFieldValue("COLOR")||"0";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_IR_SENSOR_INIT("+b+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_IR_SENSOR_INIT("+b+");\n");return"Rob.KULBOT_SET_IR_SENSOR_LED("+b+","+a+");\n"};
Blockly.Arduino.arduino_display_esp32lcdClear=function(a){a=a.getFieldValue("PORT")||"1";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_LCD_INIT("+a+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_LCD_INIT("+a+");\n");return"Rob.KULBOT_LCD_CLEAR("+a+");\n"};
Blockly.Arduino.arduino_pin_esp32setButtonLed=function(a){var b=a.getFieldValue("PORT")||"1";a=a.getFieldValue("COLOR")||"-1";-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_SENSOR_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SENSOR_INIT();\n");-1==Blockly.Arduino.setups_.setups_int.indexOf("Rob.KULBOT_BUTTON_LED_INIT("+b+")")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_BUTTON_LED_INIT("+b+");\n");var c="";"-1"!==a&&(c="Rob.KULBOT_SET_BUTTON_LED("+b+","+a+");\n");return c};
Blockly.Arduino.arduino_motors_eps32SMotorM1=function(a){var b=a.getFieldValue("MO")||"1",c=a.getFieldValue("MoFB")||"0";a=Blockly.Arduino.valueToCode(a,"OUT",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;-1==Blockly.Arduino.setups_.setups_int.indexOf("KULBOT_MOTORENCODER_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_MOTORENCODER_INIT();\n");return"Rob.KULBOT_MOTORENCODER_RUN1("+b+","+a+","+c+"); \n"};
Blockly.Arduino.arduino_motors_eps32SServo=function(a){var b=a.getFieldValue("PIN")||"1";a=Blockly.Arduino.valueToCode(a,"OUT",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;-1==Blockly.Arduino.setups_.setups_int.indexOf("KULBOT_SERVO_INIT")&&(Blockly.Arduino.setups_.setups_int+="Rob.KULBOT_SERVO_INIT();\n");return"Rob.KULBOT_SERVO_SET_ANGLE("+b+","+a+");\n"};Blockly.Arduino.arduino_serial_esp32serialBegin=function(a){return"Serial.begin("+(a.getFieldValue("VALUE")||"9600")+");\n"};
Blockly.Arduino.arduino_serial_esp32serialPrint=function(a){var b=Blockly.Arduino.valueToCode(a,"VALUE",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"";return"warp"===(a.getFieldValue("EOL")||"warp")?"Serial.println("+b+");\n":"Serial.print("+b+");\n"};Blockly.Arduino.arduino_serial_esp32serialAvailable=function(){return["Serial.available()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_serial_esp32serialReadData=function(){return["Serial.read()",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_serial_esp32multiSerialBegin=function(a){var b=a.getFieldValue("NO")||"0";a=a.getFieldValue("VALUE")||"9600";"0"===b&&(b="");return"Serial"+b+".begin("+a+");\n"};Blockly.Arduino.arduino_serial_esp32multiSerialPrint=function(a){var b=a.getFieldValue("NO")||"0";a=Blockly.Arduino.valueToCode(a,"VALUE",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"";"0"===b&&(b="");return"Serial"+b+".println("+a+");\n"};
Blockly.Arduino.arduino_serial_esp32multiSerialAvailable=function(a){a=a.getFieldValue("NO")||"0";"0"===a&&(a="");return["Serial"+a+".available()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_serial_esp32multiSerialReadAByte=function(a){a=a.getFieldValue("NO")||"0";"0"===a&&(a="");return["Serial"+a+".read()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_sensor_esp32runningTime=function(){return["millis()",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_data_esp32dataMap=function(a){var b=Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0,c=Blockly.Arduino.valueToCode(a,"ARG0",Blockly.Arduino.ORDER_UNARY_POSTFIX)||1,d=Blockly.Arduino.valueToCode(a,"ARG1",Blockly.Arduino.ORDER_UNARY_POSTFIX)||100,e=Blockly.Arduino.valueToCode(a,"ARG2",Blockly.Arduino.ORDER_UNARY_POSTFIX)||1;a=Blockly.Arduino.valueToCode(a,"ARG3",Blockly.Arduino.ORDER_UNARY_POSTFIX)||1E3;return["map("+b+", "+c+", "+d+", "+e+", "+a+
")",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_data_esp32dataConstrain=function(a){var b=Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0,c=Blockly.Arduino.valueToCode(a,"ARG0",Blockly.Arduino.ORDER_UNARY_POSTFIX)||1;a=Blockly.Arduino.valueToCode(a,"ARG1",Blockly.Arduino.ORDER_UNARY_POSTFIX)||100;return["constrain("+b+", "+c+", "+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_data_esp32dataConvert=function(a){var b=Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;switch(a.getFieldValue("TYPE")||"WHOLE_NUMBER"){case "WHOLE_NUMBER":var c="String("+b+").toInt()";break;case "DECIMAL":c="String("+b+").toFloat()";break;case "STRING":c="String("+b+")"}return[c,Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_data_esp32dataConvertASCIICharacter=function(a){return["String(char("+(Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"0")+"))",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_data_esp32dataConvertASCIINumber=function(a){return["toascii(String("+(Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"0")+")[0])",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_bluetooth_setupbluetooth=function(a){a=Blockly.Arduino.valueToCode(a,"NAME",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"Bluetooth Name";Blockly.Arduino.includes_.include_suny+='#include "BluetoothSerial.h"\n#if !defined(CONFIG_BT_ENABLED) || !defined(CONFIG_BLUEDROID_ENABLED)\n#error Bluetooth is not enabled! Please run `make menuconfig` to and enable it\n#endif\nBluetoothSerial SerialBT;';Blockly.Arduino.setups_.setups_int+="SerialBT.begin("+a+");\n";return""};
Blockly.Arduino.arduino_bluetooth_bluetoothAvailable=function(a){return["SerialBT.available()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_bluetooth_bluetoothRead=function(a){return["SerialBT.read()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.texts={};Blockly.Arduino.text=function(a){return[Blockly.Arduino.quote_(a.getFieldValue("TEXT")),Blockly.Arduino.ORDER_ATOMIC]};
